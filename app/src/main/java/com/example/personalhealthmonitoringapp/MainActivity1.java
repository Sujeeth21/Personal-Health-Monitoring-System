...
import com.example.personalhealthmonitoringapp.data.AlarmReminderContract;
import com.example.personalhealthmonitoringapp.data.AlarmReminderDbHelper;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

public class MainActivity1 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
...
*/
        ...
        reminderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity1.this, AddReminderActivity.class);
